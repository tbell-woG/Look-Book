    ...
    return (
        <div>
            <div className="card">
                ...
                <p style={{ fontFamily: "'Libre Baskerville', serif", fontSize: "18px" }}>Welcome to <i>Look-Book</i>, an open space where you can view art from all periods of time, from all
